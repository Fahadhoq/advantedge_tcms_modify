                        ...
                        <div class="col-xl-12">
                            <div class="card m-b-30">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- message show end -->
                            <div class="col-xl-6">
                                <form action="{{ route( 'expense_gl_code.create' ) }}" method="post" >
                                @csrf
                                <div class="form-group">
                                    <lable style=font-weight:bold>GL Code Name </lable>
                                    <input type="text" class="form-control" name="ExpenseGLCodeName" value="{{ old('ExpenseGLCodeName') }}" placeholder="Enter GL Code name">
                                </div>
                                    ...
                                    <div style=text-align:center class="col-xl-12">
                                        ...
                                        <!-- cancle from -->
                                        <a href="{{ route( 'permission.index' ) }}" class="btn btn-danger"> {{ __('cancle') }}</a>
                                        <!-- cancle from end -->
                                    <div> 
                            </div> 
