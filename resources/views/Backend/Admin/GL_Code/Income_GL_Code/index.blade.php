                 ...
                 <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                <h4 class="page-title">ALL INCOME GL CODES</h4>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-right">
                                    ...
                                    <li class="breadcrumb-item active">ALL INCOME GL CODES </li>
                                </ol>
                            </div>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                @foreach($IncomeGLCodes as $IncomeGLCode)
                                                    <tr>
                                                        ...
                                                        <!-- <a href="{{ route('expense_gl_code.view' , $IncomeGLCode->id) }}" class="btn btn-info btn-sm" title="View Role"><i class="fa fa-eye"></i></a> -->
                                                        <!-- jquery view -->
                                                        <a name="view" value="view" id="{{$IncomeGLCode->id}}" class="btn btn-info btn-sm view_Income_GL_Code" title="View Income GL Code"><i class="fa fa-eye"></i></a>
                                                        <!-- jquery view end-->
                                                        
                                                        <!-- <a href="{{ route('expense_gl_code.edit' , $IncomeGLCode->id) }}" class="btn btn-warning btn-sm" title="Edit Role"><i class="fa fa-edit"></i></a> -->
                                                        <!-- jquery edit -->  
                                                        ...
                                                        <!-- <a href="{{ route('expense_gl_code.delete' , $IncomeGLCode->id) }}" class="btn btn-danger btn-sm" title="delete Role" onclick="return confirm('Are you sure to delete?')"><i class="fa fa-trash"></i></a> -->
...
//view gl code
$(document).on('click', '.view_Income_GL_Code', function(){

           var csrf_token = $('input[name=_token]').val();  
           var gl_code_id = $(this).attr("id"); 
         //  console.log(Permission_id);
           var url = '/income_gl_code-show-'; 
...
$(document).on('click', '.edit_data', function(){  
           var gl_code_id = $(this).attr("id");  
           var csrf_token = $('input[name=_token]').val();   
           var url = '/income_gl_code-JqueryEdit-'; 
      ...
      $('#insert_form').on("submit", function(event){  
           ...
           {  
               ...
               var csrf_token = $('input[name=_token]').val();
               var url = '/income_gl_code-JqueryUpdate-';
