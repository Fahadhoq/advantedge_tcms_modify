                                ...
                                <div class="col-lg-6">
                                    <div class="p-20">
                                               ...
                                               <div class="form-group">
                                                    <label>Amount</label>
                                                    <div>
                                                        <input type="text" id="IncomeAmount" name="IncomeAmount" value="{{ old('IncomeAmount') }}"
                                                            class="form-control"
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input class="form-control" type="date" value="{{ old('IncomeDate') }}" name="IncomeDate" id="IncomeDate">
                                                    </div>
                                                </div>
                                    ...
                                    <!-- 2nd part              -->
                                        <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Remark</label>
                                                    <div>
                                                        <input type="text" id="IncomeRemark" name="IncomeRemark" value="{{ old('IncomeRemark') }}"
                                                            class="form-control"
