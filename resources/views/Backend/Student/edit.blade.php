                ...
                <div class="row">           
                     ...
                     <!-- div 1 -->                                 
                        ...
                        <!-- nav heading end -->
                            ...
                            <form action="{{ route( 'student.edit' , $user->id ) }}" id="EditForm" method="post"  enctype="multipart/form-data">
                                 @csrf
                           ...
                           <!-- 1st part              -->
                                <div class="col-lg-6">
                                   ...
                                   <div style=text-align:center class="col-xl-12">
                                        ...
                                        <!-- cancle from -->
                                        <a href="{{ route( 'student.index' ) }}" class="btn btn-danger"> {{ __('cancle') }}</a>
                                        <!-- cancle from end -->
                                    </div> 
                                      <!-- button div  end-->
