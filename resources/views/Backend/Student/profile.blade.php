                    ...
                    <div class="page-title-box">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-3" style="background-color:#92cd00">
                                <h4 class="page-title" style=text-align:center>@if(isset($is_deleted))  THE STUDENT WAS DELETED  @endif </h4>
                            </div>
  ...
  <div class="profile-nav col-md-3">
      <div class="panel">
          ...
          <ul class="nav nav-pills nav-stacked">
              <li><a href="{{ route('student.edit' , $user->id) }}"> <i class="fa fa-edit"></i> Edit profile</a></li>
          </ul>
      </div>
  </div>
