                                ...
                                <div class="card-body">
                                   ...
                                   <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer col-md-12">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody id="TableData">
                                                @php $i=1 @endphp
                                                @foreach($student_payment_infos as $student_payment_info)
                                                    <tr>
                                                        <td style=text-align:center scope="row">{{$i++}}</td>   
                                                       
                                                        <td style=text-align:center>{{$student_payment_info->id}}</td>
                                                        <!-- <td style=text-align:center>
                                                        <label><a href="{{ route('user.view' , $student_payment_info->id) }}" class="hover" id="{{$student_payment_info->id}}">{{$student_payment_info->name}}</a></label>    
                                                        </td> -->
                                                        <td style=text-align:center>{{$student_payment_info->created_at->format("m/d/Y")}}</td>
                                                        <td style=text-align:center>not make</td>
                                                        
                                                        <td style=text-align:center>

                                                        <a href="{{ route('user.view' , $student_payment_info->id) }}" class="btn btn-info btn-sm" title="View USer"><i class="fa fa-eye"></i></a>
                                                        @can('user edit')
                                                        <a href="{{ route('user.edit' , $student_payment_info->id) }}" class="btn btn-warning btn-sm" title="Edit User"><i class="fa fa-edit"></i></a>
                                                        @endcan
                                                        ...
                                                        <!-- jquery delete -->
                                                        <button class="btn btn-danger btn-sm delete" data-id="{{$student_payment_info->id}}" value="{{$student_payment_info->id}}"><i
